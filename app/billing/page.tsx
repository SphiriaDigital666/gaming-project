...
import cardBgOne from "@/public/images/billing-page/card-bg-one.png";
  ...
  return (
    <div className={montserrat.className}>
      ...
      <div className="relative bg-[#051301]">
        ...
        <div className="flex flex-col md:flex-row gap-6 xl:gap-28 lg:px-10 mx-auto container px-[2em] md:px-0 py-[1em]">
          <BillingDetailsForm />
          <OrderDetails />
        </div>
